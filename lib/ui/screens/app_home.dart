                ...
                child: DragTarget<Carga>(
                  ...
                  onAcceptWithDetails: (details) {
                    ...
                    setState(() {
                      ...
                      cargaArrastrada.pos.x =
                          posicionLocal.dx - tamanoIzq - _tamanoDivisor;
                  ...
                  builder: (context, candidateData, rejectedData) {
                    return Container(
                      color: Colors
                          .grey[900], // Fondo oscuro para que resalten las cargas y vectores
                      child: Stack(
                        children: [
                          ...
                          ...cargas.map((c) {
                            ...
                            Color colorCarga = c.magnitud > 0
                                ? Colors.red
                                : Colors.blue;
                            IconData iconoCarga = c.magnitud > 0
                                ? Icons.add_circle
                                : Icons.remove_circle;
                              ...
                              child: GestureDetector(
                                ...
                                onLongPress: () {
                                  setState(() {
                                    cargas.remove(
                                      c,
                                    ); // La borramos por completo de la lista unificada
                                  });
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        '${c.nombre} eliminada del simulador',
                                      ),
                                    ),
                                  );
                                },
